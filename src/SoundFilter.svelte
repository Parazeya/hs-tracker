    ...
    <div class="section" style:border-image-source={css('chip_dark')}>
      ...
      {#each ALERT_RARITIES as rarity}
        ...
        <div class="rrow" class:off={!on}>
          ...
          <div class="rbtns">
            <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => testRarity(key)}>{t("Test")}</button>
            <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => pickRaritySound(key)}>{t("Browse…")}</button>
            <button
              class="btn sm"
      ...
      <div class="rrow" class:off={!settings.mail?.enabled}>
        ...
        <div class="rbtns">
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => testRarity('mail')}>{t("Test")}</button>
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => pickRaritySound('mail')}>{t("Browse…")}</button>
          <button
            class="btn sm"
            style:--btn={css('button')}
            style:--btn-hover={css('button_hover')}
      ...
      <div class="rrow" class:off={!settings.zone?.enabled}>
        ...
        <div class="rbtns">
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => testRarity('zone')}>{t("Test")}</button>
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => pickRaritySound('zone')}>{t("Browse…")}</button>
          <button
            class="btn sm"
            style:--btn={css('button')}
            style:--btn-hover={css('button_hover')}
  ...
  {#if settings}
    ...
    <div class="section" style:border-image-source={css('chip_dark')}>
      ...
      <div class="rrow" class:off={!settings.relic?.enabled}>
        ...
        <span class="btns">
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => testRarity('relic')}>{t("Test")}</button>
          <button class="btn sm" style:--btn={css('button')} style:--btn-hover={css('button_hover')} style:--btn-down={css('button_down')} onclick={() => pickRaritySound('relic')}>{t("Browse…")}</button>
          <button
            class="btn sm"
            style:--btn={css('button')}
            style:--btn-hover={css('button_hover')}
