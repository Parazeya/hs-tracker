...
import './theme.css';
// Two flat skins, each with its own stylesheet, and both are loaded on every
// window. They cannot collide: modern.css is scoped under
// html[data-theme='modern'] and plain.css under html[data-skin='plain'], so a
// skin only ever sees its own rules. plain.css is not optional even under
// Modern — the :root at the top of it declares --face and --pick-rgb, which
// every skin reads.
import './modern.css';
import './plain.css';
